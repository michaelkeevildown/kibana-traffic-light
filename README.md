...
`bin/kibana-plugin install https://github.com/michaelkeevildown/kibana-traffic-light/releases/download/vmajor.minor.patch/kibana-traffic-light-major.minor.patch.zip`
